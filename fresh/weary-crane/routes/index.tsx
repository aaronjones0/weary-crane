...
export default function Home() {
  ...
  return (
    <div class="px-4 py-8 mx-auto" style={{ backgroundColor: theme.surface1 }}>
      <div class="max-w-screen-md mx-auto h-full flex flex-col gap-4 items-center justify-center">
